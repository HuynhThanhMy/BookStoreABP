...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e26a24da-8cce-4117-8bbf-a62e6aff58dd
```

> `e26a24da-8cce-4117-8bbf-a62e6aff58dd` is the password of the certificate, you can change it to any password you want.
